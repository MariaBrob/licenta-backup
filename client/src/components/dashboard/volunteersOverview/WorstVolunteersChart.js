...
import { getWorstVolunteersChart } from "../../../actions/membersActions";
...
export default function Chart() {
  ...
  const sortedVolunteers = useSelector(
    (state) => state.volunteers.sortedVolunteersWorstAll
  );
  ...
  React.useEffect(() => {
    dispatch(getWorstVolunteersChart(selectedYear));
