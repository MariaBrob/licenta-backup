...
router.post("/getBest10VolunteersbyDep", (req, res) => {
  const { year } = req.body;
  Volunteer.find({})
    .then((resp) => {
      var vol_array = [];
...
router.post("/getBest10Volunteers", (req, res) => {
  const { year } = req.body;
  Volunteer.find({})
    .then((resp) => {
      var vol_array = [];
...
router.post("/getWorst10Volunteers", (req, res) => {
  const { year } = req.body;
  Volunteer.find({})
    .then((resp) => {
      var vol_array = [];
...
router.post("/getWorst10VolunteersDep", (req, res) => {
  const { year } = req.body;
  Volunteer.find({})
    .then((resp) => {
      var vol_array = [];
...
router.post("/getWorst10VolunteersDepChart", (req, res) => {
  const { year } = req.body;
  Volunteer.find({})
    .then((resp) => {
      var vol_array = [];
